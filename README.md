...
release 3.0.2. Please follow these two steps to migrate to 3.0.2 version
...
2.	Download the latest ConvivaAVFoundation Module [here](https://github.com/Conviva/ConvivaAVFoundation/archive/3.0.2.zip)
