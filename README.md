...
## Cocoapods Installation
    ...
    pod 'ConvivaAVFoundation','4.0.37'
...
2. Select version as:
    * 4.0.37 if it's with Advertising Identifier Support.
...
2.	Download the latest ConvivaAVFoundation Module from below path.
    * [Without Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaAVFoundation/archive/4.0.37.zip)
    OR
