...
## Cocoapods Installation
    ...
    pod 'ConvivaAVFoundation','3.0.10'
...
1.	Download the latest ConvivaCore [here](https://github.com/Conviva/ConvivaCore/archive/3.0.9.zip)

2.	Download the latest ConvivaAVFoundation Module [here](https://github.com/Conviva/ConvivaAVFoundation/archive/3.0.10.zip)
