...
2. Select version as:
    * 4.0.44 if it's with Advertising Identifier Support.
    * 4.0.45 if it's without Advertising Identifier Support.
...
2.	Download the latest ConvivaAVFoundation Module from below path.
    * [Without Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaAVFoundation/archive/4.0.45.zip)
    OR
    * [With Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaAVFoundation/archive/4.0.44.zip)
