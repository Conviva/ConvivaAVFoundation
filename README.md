...
## Cocoapods Installation
    ...
    pod 'ConvivaAVFoundation','4.0.57'
...
2. Select version as:
    ...
    * 4.0.57 if it's without Advertising Identifier Support.
...
1.	Download the latest ConvivaSDK/ConvivaCore from below paths.
    ...
    * ConvivaSDK
      * [Without Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaSDK/archive/4.0.51.zip)
      OR
...
2.	Download the latest ConvivaAVFoundation Module from below path.
    * [Without Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaAVFoundation/archive/4.0.57.zip)
    OR
