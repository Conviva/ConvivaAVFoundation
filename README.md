...
1.	Download the latest ConvivaSDK/ConvivaCore from below paths.
    ...
    * ConvivaSDK
      * [Added support to report Ad events](https://github.com/Conviva/ConvivaSDK/archive/4.3.2.zip)

2.	Download the latest ConvivaAVFoundation Module from below path.
    * [Added support to report Ad events](https://github.com/Conviva/ConvivaAVFoundation/archive/4.3.2.zip)
